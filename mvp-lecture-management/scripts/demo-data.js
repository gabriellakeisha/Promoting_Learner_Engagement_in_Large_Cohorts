...
// ============================================
// MESSAGE CONTENT — CS-focused, realistic
// ============================================
...
const QUESTION_MSGS = [
  ...
  "When would we use a hash table instead of a balanced BST?",
  "Is polymorphism the same as method overriding or is it broader than that?",
  ...
  "Why is HTTPS important and how does TLS handshake work?",
...
const COMMENT_MSGS = [
  ...
  "I found a good Stack Overflow thread about this topic if anyone's interested",
  ...
  "This connects well to what we covered in last week's practical session",
  ...
  "The example code in the slides has a small typo on line 15 by the way",
  "I agree, this approach is much cleaner than the alternative we discussed",
  ...
  "Really useful real-world application example",
  "This is similar to how Netflix handles their recommendation system",
  "Makes sense now, thanks for breaking it down step by step",
  "The practice problems on Canvas are really helpful for this topic",
];

const CONFUSION_MSGS = [
  "I'm lost on how the recursion base case works here",
  "Can we slow down? The pointer arithmetic is confusing",
  ...
  "Can we revisit the normalisation steps? I'm still unclear on 3NF",
  ...
  "Not following how the DNS resolution process works",
